...
public class Varasto {
    ...
    public Varasto(double tilavuus) {  // tilavuus on annettava
        maaritaVarastonTilavuus(tilavuus);
        saldo = 0;     // oletus: varasto on tyhjä
    }

    public void maaritaVarastonTilavuus(double tilavuus) {
        if (tilavuus > 0.0) {
    ...
    public void maaritaVarastonAlkuSaldo(double alkuSaldo) {
        if (alkuSaldo < 0.0) {
            this.saldo = 0.0;
    ...
    public Varasto(double tilavuus, double alkuSaldo) { // kuormitetaan
        maaritaVarastonTilavuus(tilavuus);
        maaritaVarastonAlkuSaldo(alkuSaldo);
    }
